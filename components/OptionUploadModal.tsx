                        ...
                        {options.map((opt, idx) => (
                            <div key={idx} className="bg-white p-2 rounded shadow relative group">
                                ...
                                <button 
                                    ...
                                    className="absolute top-2 right-2 bg-red-600 text-white w-6 h-6 rounded-full flex items-center justify-center font-bold opacity-0 group-hover:opacity-100 transition shadow"
                                    title="Eliminar"
                                >
                                    ✕
                                </button>
